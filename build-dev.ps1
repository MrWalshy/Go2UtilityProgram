...
Copy-Item app/logic/ryzenadj/WinRing0x64.sys release/
Copy-Item app/logic/ryzenadj/libryzenadj.dll release/
Copy-Item app/logic/ryzenadj/WinRing0x64.dll release/